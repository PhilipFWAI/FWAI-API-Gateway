...
import { isBodyValidation, isHeaderValidation, isParamValidation } from '../middlewares/requestMiddleware';
import { signupSchema, userDeviceSchema, signinSchema, authorizationSchema, accessTokenSchema } from '../modules/auth/validation/authValidation';

const router: Router = Router();

router.get('/verify-email/:access_token', isParamValidation(accessTokenSchema), isAccountVerified, authController.verifyEmail);
